...
See more detail about the methodology, results and discussion in "NDL Unpaid Carers report 2023.pdf" located in the folder "Report". 
...
This repo is organised into the following folders:<br> 
    ...
    2) Codes<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Subfolders:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     1_Matching_and_preprocessing - contains the scripts for data pre-processing <br> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     2_LTCs_before_becoming_a_carer - contains the scripts for the analysis of LTCs of carers before they were identified as carers <br> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     3_Health_metrics - containts the scripts for analysis of the effect of being a carer on frailty, BMI and self-management <br> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     4_Healthcare_access - containts the scripts for analysis of the effect of being a carer on health care access <br> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     5_COVIDeffect_on_referrals - contains the script to perform interrpted time series to assess the effect of being a carer (COVID-19) on referrals by specialty<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     6_Age-sex_standardised_rate - containts the script to get age-sex standardised rates for LTCs for unpaid carers and matched controls<br>
    3) Report - contains the report with the results about unpaid carers <br> 
...
### Authors 
 ...
 - Sandeep Parshar - Data extraction and descriptive analysis <br> 
 - Clare McCrudden - PPIE lead <br> 
 - Anna Lawrence-Jones - PPIE lead <br> 
 - Lewis Thomas - project management <br> 
 - Jacob Oguntimehin - project management <br> 
 - Helena Gavrielides - project management <br> 
 - Rachel McCarthy - data development <br> 
 - Alex Bottle - advice on statistics <br> 
 - Melanie Leis - project lead (IGHI) <br> 
 - Matthew Chisambi - project lead (ICHP) <br> 
